package com.liuyang.iotinfluxdb_api.monitor;
...
public class IotMonitorServices {
    ...
    public JSONObject getJVMInfo(){
        ...
        logger.debug("heapMemoryUsed: {}", heapMemoryUsed);
        logger.debug("heapMemoryMax: {}", heapMemoryMax);
        ...
        logger.debug("nonHeapMemoryUsed: {}", nonHeapMemoryUsed);
        logger.debug("nonHeapMemoryMax: {}", nonHeapMemoryMax);
        ...
        logger.debug("classLoadedNum: {}", classLoadedNum);
        logger.debug("classLoadTotalNum: {}", classLoadTotalNum);
